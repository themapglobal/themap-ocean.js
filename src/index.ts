...
async function main() {
  ...
  console.log(`Goal node symbol: ${await goalPyWasm.symbol()}`)
  console.log(`Goal node name: ${await goalPyWasm.name()}`)
  ...
  console.log(`Goal node symbol: ${await goalPyBrowser.symbol()}`)
  console.log(`Goal node name: ${await goalPyBrowser.name()}`)
  ...
  console.log(`Project node symbol: ${await projectX.symbol()}`)
  console.log(`Project node name: ${await projectX.name()}`)
  ...
  console.log(`Project node symbol: ${await projectY.symbol()}`)
  console.log(`Project node name: ${await projectY.name()}`)
  ...
  console.log(`Project node symbol: ${await projectPyscript.symbol()}`)
  console.log(`Project node name: ${await projectPyscript.name()}`)
